pipeline {
    ...
    stages {
        stage('install terraform') {
	      ...
	      sh 'sudo rm -rf /var/lib/jenkins/workspace/terraform-aws-eks-cluster/terraform'
	      sh 'sudo rm -rf /var/lib/jenkins/workspace/terraform-aws-eks-cluster/terraform_0.12.24_linux_amd64.zip'
