pipeline {
    ...
    stages {
        stage('install terraform') {
	      ...
	      sh 'sudo rm -rf /var/lib/jenkins/workspace/eks-1/terraform_0.12.24_linux_amd64.zip'
              sh 'sudo wget https://releases.hashicorp.com/terraform/0.12.23/terraform_0.12.24_linux_amd64.zip'
